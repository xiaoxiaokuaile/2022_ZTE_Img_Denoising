...
from NAFNet import LayerNorm2d, NAFBlock
...
class NAFNetSR(nn.Module):
    ...
    '''
    def __init__(self, up_scale=4, width=48, num_blks=16, img_channel=4, drop_path_rate=0., drop_out_rate=0., fusion_from=-1, fusion_to=-1, dual=False):
        super().__init__()
...
class NAFSSR(Local_Base, NAFNetSR):
    def __init__(self, *args, train_size=(1, 6, 30, 90), fast_imp=False, fusion_from=-1, fusion_to=1000, **kwargs):
        ...
        NAFNetSR.__init__(self, *args, img_channel=4, fusion_from=fusion_from, fusion_to=fusion_to, dual=True, **kwargs)
...
if __name__ == '__main__':
    # up_scale=4, width=48, num_blks=16, img_channel=4, drop_path_rate=0., drop_out_rate=0., fusion_from=-1, fusion_to=-1, dual=False
    model = NAFNetSR(up_scale=1, width=64, num_blks=32,img_channel=4, drop_path_rate=0.1)
    model.eval()
    # print(model)
