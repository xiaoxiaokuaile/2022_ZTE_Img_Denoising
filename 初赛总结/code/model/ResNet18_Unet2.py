...
class ResNet18_Unet2(nn.Module):
    ...
    def save(self, circle):
        name = "./weights/ResNet18_Unet2" + str(circle) + ".pth"
...
if __name__ == '__main__':
    ...
    # input = torch.from_numpy(np.random.randn(1, 3, 512, 512)).float()
    # model1 = nn.Sequential(
    #     net.conv1,    # torch.Size([1, 64, 256, 256])
    #     net.bn1,
    #     net.act1,
    #     net.maxpool,  # torch.Size([1, 64, 128, 128])
    #     net.layer1,   # torch.Size([1, 64, 128, 128])
    #     net.layer2,   # torch.Size([1, 128, 64, 64])
    #     net.layer3,   # torch.Size([1, 256, 32, 32])
    #     net.layer4,   # torch.Size([1, 512, 16, 16])
    #     net.global_pool,   # torch.Size([1, 512])
    #     net.fc,   # torch.Size([1, 1000])
    # )
    # output = model1(input)
    # print(net)
    # print(output.shape)
